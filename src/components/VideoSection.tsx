...
const VideoSection = () => {
  ...
  return (
    <section id="video-section" className="section bg-hollywood-darker relative">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-gradient-primary">
            See Screenplay Writer GPT in Action
          </h2>
          <p className="text-white/80 text-lg max-w-2xl mx-auto">
            Watch how our powerful AI assistant helps you create engaging, professional screenplays with ease.
          </p>
        </div>
        ...
        <div className={`max-w-4xl mx-auto glass-card p-4 overflow-hidden transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="aspect-w-16 aspect-h-9 relative">
            <iframe 
              ...
              src="https://www.youtube.com/embed/WHGRABnjfxA?autoplay=1&mute=0&controls=1&origin=https://screenplay-writer-gpt.lovable.app&playsinline=0&showinfo=0&rel=0&modestbranding=1&cc_load_policy=0&fs=1&enablejsapi=1&widgetid=1&hd=1"
