      ...
      <div className="container-custom relative z-10 px-4 sm:px-6">
        ...
        <div className="text-center mt-4 sm:mt-6">
          <p className="text-xs sm:text-sm text-white/60">
            Unlock Your Dreams ~ <a href="https://aiwebtools.lovable.app/?via=aiwebtools" target="_blank" rel="noopener noreferrer" className="text-hollywood-primary hover:underline">AiWebTools.Ai</a>
          </p>
        </div>
      </div>
    </section>
